...
export async function GET(req: NextRequest) {
  try {
    ...
    const promptText = `Generate a random word for pronunciation suitable for a ${ageLevel} year old. Only one word is needed. Response should just be the word, its pronunciation, and a sentence using the word.`;
